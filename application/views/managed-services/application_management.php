...
<style>
    ...
    .WhyZenosys .WhyZenosysContent h2:before{content: unset;}
            ...
            <img src="<?php echo base_url(); ?>assets/images/application-management.png" class="img-fluid CommanImg GovernmentImg fullwidth fullwidth2 Retail Telecommunication">
        </div>
            </div>
