...
<style>
    ...
    .WhyZenosys .WhyZenosysContent h2:before{content: unset;}
           ...
           <div class="col-md-4 WhyZenosysContent WhyZenosysContentCustome">
            <img src="<?php echo base_url(); ?>assets/images/codeigniterimg.png" class="img-fluid CommanImg GovernmentImg fullwidth fullwidth2 Retail Telecommunication" style="bottom:0;top:172px;margin:auto;transform: scale(1.1);">
        </div>
                 </div>
            <div class="row CustomeRows">
