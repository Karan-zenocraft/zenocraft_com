        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center justify-content-start">
                    ...
                    <div class="Address">
                        <a class="TitleP" href="<?php echo base_url() ?>assets/images/zenosys_brochure.pdf" style="color: #728194">Download / Zenocraft Service Offering <i class="fa fa-download ml-1"></i> </a>
                    </div>
